...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		// This gets the "myconfig" section of the YAML and reads it as a string.
		// "myconfig" can be, for example, a pipped config.
		vi := viper.GetString("myconfig")
		fmt.Println(vi)
...
func init() {
	...
	// foobarCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
