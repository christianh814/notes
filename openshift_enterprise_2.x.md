...
{{::ose_setup_-_example_-_network_general.png|}} 
...
*  Create a DNS entry for the node [DNS entry](openshift_enterprise_2.x#creating_dns_entries)

*  [Install the Node](openshift_enterprise_2.x#node) like you would normally

*  Add the node to a [[openshift_enterprise_2.x#adding_profile_w_district|district
]]
